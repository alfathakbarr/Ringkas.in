...
@section('content')
            ...
            <div class="grid lg:grid-cols-2 gap-7 items-start">
                <div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        <a href="{{ route('urls.create') }}" class="focus-ring interactive-press inline-flex items-center justify-center rounded-xl bg-linear-to-r from-blue-600 to-violet-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-300/40 hover:brightness-105 transition">Buka Short URL Page</a>
                        <a href="{{ route('urls.qr') }}" class="focus-ring interactive-press inline-flex items-center justify-center rounded-xl border border-indigo-200 bg-white px-5 py-2.5 text-sm font-semibold text-indigo-700 hover:bg-indigo-50 transition">Buka QR Page</a>
                    </div>
                </div>

                <div class="space-y-4">
                    <div class="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 surface-hover">
    ...
    <section class="section-enter">
        <div class="grid sm:grid-cols-2 gap-4">
            <div class="glass-card rounded-2xl border border-white/70 p-5 shadow-soft surface-hover">
